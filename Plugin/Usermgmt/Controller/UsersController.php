<?php
    ...
    class UsersController extends UserMgmtAppController
    {
        ...
        {
            if(isset($this->request->query['checkout']))
            {
            ...
            if($this->request->isPost())
            {
                ...
                if($this->User->LoginValidate())
                {
                    ...
                    if($user['User']['password'] === $hashed)
                    {
                        ...
                        if(isset($_GET['checkout']) || isset($this->request->query['checkout']))
                        {
                            $this->redirect(array('plugin' => false, 'controller' => 'orders', 'action' => 'checkout'));
                        } else if($user['User']['user_group_id'] == 2)
                        {
                            $this->redirect(array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'userDashboard'));
                        } else
                        {
        ...
        public function addUser()
        {
            ...
            if($this->request->isPost())
            {
                ...
                // debug( $_restaurants[$this->request->data['User']['restaurantid']]);die();
