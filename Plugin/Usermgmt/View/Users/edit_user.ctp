<div class="row">
    <?php echo $this->Form->create('User', array('action' => 'editUser', 'type' => 'file')); ?>
    ...
    <div class="form-group col-md-12">
        ...
        <img class="thumbnail" height="150" width="150" src="/files/user/photo/<?php echo $this->data['User']['photo_dir'] . '/' . $this->data['User']['photo'] ?>"/>
    </div>
