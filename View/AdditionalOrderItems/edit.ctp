<div class="row">
    ...
    <fieldset>
        <legend><?php echo __('Edit Additional Order Item'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AdditionalOrderItem.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('AdditionalOrderItem.id'))); ?></li>
