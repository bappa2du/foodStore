<div class="row">
    ...
    <fieldset>
        <legend><?php echo __('Edit Cusine Restaurant'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CusineRestaurant.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CusineRestaurant.id'))); ?></li>
