<div class="row">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->input('food_id', array('div' => array('class' => 'form-group col-md-6'), 'class' => 'form-control'));
            echo $this->Form->input('discount_amount', array('div' => array('class' => 'form-group col-md-6'), 'type' => 'text', 'class' => 'form-control'));
            echo $this->Form->input('discount_type', array('div' => array('class' => 'form-group col-md-6'), 'type' => 'select', 'class' => 'form-control', 'options' => array('%' => '%', 'fixed' => 'Fixed')));
