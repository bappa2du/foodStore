        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li>
                    <?php
                        echo $this->Html->link(
                            'Contact', '#', array('class' => 'ajaxlink', 'data-href' => Router::url(array('controller' => 'webpages', 'action' => 'view', '53a5ace3-8d3c-4b29-bbb8-1864fcf384cf', '?' => array('layout' => 'ajax'))), 'data-holder' => '#ajaxPage')
                        );
                    ?>
                </li>
                <li>
                    <?php
                        echo $this->Html->link(
                            'Site Map', '#', array('class' => 'ajaxlink', 'data-href' => Router::url(array('controller' => 'webpages', 'action' => 'view', '53a5adfb-ed2c-4752-92b5-1864fcf384cf', '?' => array('layout' => 'ajax'))), 'data-holder' => '#ajaxPage')
                        );
                    ?>
                </li>
            </ul>
